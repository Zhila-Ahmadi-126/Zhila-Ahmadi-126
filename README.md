  ...
  <defs>
    ...
    <linearGradient id="bg" x1="0%" y1="0%" x2="100%" y2="0%">
      <stop offset="0%" stop-color="#00c6ff">
        <animate attributeName="stop-color" values="#00c6ff;#ff00cc;#00ffcc;#00c6ff" dur="6s" repeatCount="indefinite"/>
      </stop>

      <stop offset="50%" stop-color="#ff00cc">
        <animate attributeName="stop-color" values="#ff00cc;#00ffcc;#00c6ff;#ff00cc" dur="6s" repeatCount="indefinite"/>
      </stop>

      <stop offset="100%" stop-color="#00ffcc">
        <animate attributeName="stop-color" values="#00ffcc;#00c6ff;#ff00cc;#00ffcc" dur="6s" repeatCount="indefinite"/>
      </stop>
    </linearGradient>
